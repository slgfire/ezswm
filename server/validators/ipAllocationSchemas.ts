...
export const createIpAllocationSchema = z.object({
  ...
  device_type: z.enum(['server', 'switch', 'printer', 'phone', 'ap', 'camera', 'other']).optional(),
...
export const updateIpAllocationSchema = z.object({
  ...
  device_type: z.enum(['server', 'switch', 'printer', 'phone', 'ap', 'camera', 'other']).optional().nullable(),
