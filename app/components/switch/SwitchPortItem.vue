<template>
  ...
  >
    ...
    <!-- PoE indicator: small lightning bolt at bottom center -->
    <span v-if="port.poe" class="absolute bottom-0 left-1/2 -translate-x-1/2 text-amber-400 text-[8px] leading-none">⚡</span>
