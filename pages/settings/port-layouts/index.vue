...
<template>
  <div>
    <div class="row row-between">
      ...
      <NuxtLink to="/settings/port-layouts/new"><button>New layout</button></NuxtLink>
    </div>

    <div v-for="layout in items || []" :key="layout.id">
      <LayoutPreview :layout="layout" />
      <div class="row" style="margin-bottom: 1rem;">
        <button class="secondary" @click="router.push(`/settings/port-layouts/${layout.id}`)">Edit</button>
