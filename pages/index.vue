  ...
  <div>
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      ...
      <UCard>
        ...
        <UProgress class="mt-2" :model-value="data?.portUtilization ?? 0" />
      </UCard>
      <UCard>
    ...
    <UCard class="mt-4">
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <UButton size="xs" icon="i-lucide-refresh-cw" variant="soft" @click="refresh" />
        </div>
      </template>
      <div class="space-y-3">
        <div v-for="entry in data?.subnetUsage || []" :key="entry.networkId">
